...
def project_2d(
    ...
    # print("Called by: get_projected_joints")
    # print("Input: args=args, df=df, i=idx, pNum=pNum, joints3d=gt_verts_local/gt_verts_joints")
    dslr_sens_width = 36
    ...
    # print("Output: gt2d, gt3d_camCoord, cam_j3d, camR, camT, camK")
...
def project2d(
        ...
        camPitch=0,
        camYaw=0):
    # print("Called by: project_2d")
    # print("Input: j3d=joints3d, etc.")
    ...
    ''' newly added for Euler angles Calculation '''
    # print("Output: j2d, j3d_new, cam_j3d, camR, camT, camK")
