...
def main():
    ...
    if "train" == data_type:
        if "AGORA" in mypath:
            if not os.path.exists(os.path.join(output_path, "AGORA")):
                os.mkdir(os.path.join(output_path, "AGORA"))

            output_path = os.path.join(output_path, "AGORA")
            img_path = os.path.join(mypath, "images", "train")
            json_path = os.path.join(mypath, "annotations", "full_body_head_coco_style_train.json")
        if "CMU" in mypath:
            if not os.path.exists(os.path.join(output_path, "CMU")):
                os.mkdir(os.path.join(output_path, "CMU"))

            output_path = os.path.join(output_path, "CMU")
            img_path = os.path.join(mypath, "images", "train")
            json_path = os.path.join(mypath, "annotations", "coco_style_sampled_train.json")
    if "val" == data_type:
        if "AGORA" in mypath:
            if not os.path.exists(os.path.join(output_path, "AGORA")):
                os.mkdir(os.path.join(output_path, "AGORA"))
            ...
            json_path = os.path.join(mypath, "annotations", "full_head_coco_style_validation.json")
        if "CMU" in mypath:
            if not os.path.exists(os.path.join(output_path, "CMU")):
                os.mkdir(os.path.join(output_path, "CMU"))
            ...
            json_path = os.path.join(mypath, "annotations", "head_coco_style_sampled_validation.json")
